...
class SparsePixelMap(torch.utils.data.Dataset):
    def __init__(self, topdir, subdir, apply_jitter, standardize_input, limit=None):
        '''Initialiser for SparsePixelMapNOvA class'''
        self.files = glob.glob(os.path.join(topdir, subdir, "*.pt"))
